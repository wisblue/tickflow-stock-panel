...
from app.api import active_stocks, analysis, auth as auth_api, backtest, data, ext_data, financials, hot_concepts, indices, intraday, kline, live_telegram, market_recap, model_v4, monitor_rules, alerts, overview, pipeline, rps, screener, settings as settings_api, signals, stock_analysis, strategy, watchlist
...
app.include_router(active_stocks.router)
app.include_router(screener.router)
app.include_router(backtest.router)
app.include_router(model_v4.router)
...
app.include_router(hot_concepts.router)
app.include_router(live_telegram.router)
